...
public class HelloWorld
{
	public static void main(String args[])
	{
		...
		/*
		 	...
		 	System.out.println takes what is in the parenthesis, prints (displays) it, and moves to a new line.
		 */
		System.out.println("Hello World");
		//The double quotations indicates the contents are a String, or collection of characters.  We will get more into data
		//types later
	} //curley brackets are used to define blocks of code.  For right now, know that this curley bracket ends the program.
}